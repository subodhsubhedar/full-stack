							...
							<p class="card-text">
								...
								<spring:bind path="subtitle">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<form:input path="subtitle" type="text" class="form-control ${status.error ? 'is-invalid' : ''}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<form:input path="durationInHrs" type="number"
												class="form-control ${status.error ? 'is-invalid' : ''}" id="duration"
												placeholder="Duration in hrs" size="4"
