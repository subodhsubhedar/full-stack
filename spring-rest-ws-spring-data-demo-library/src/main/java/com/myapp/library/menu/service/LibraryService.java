...
public interface LibraryService {
	...
	Book getBookById(Long bookId) throws LibraryServiceException;
	
	void deleteBookById(Long bookId) throws LibraryServiceException;
	
	Book updateBook(Book book) throws LibraryServiceException;
}
