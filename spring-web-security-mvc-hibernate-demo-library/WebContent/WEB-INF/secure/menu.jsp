			...
			<div class="jumbotron">
				...
				<p>
					<security:authentication property="principal.authorities"
						var="userAuthorities" />
					<c:set var="userAuthVar" value="${userAuthorities}" />

					<c:forEach var="menu" items="${menuModelList}">

						<c:forEach var="menuAllowedRole" items="${menu.allowedRoles}">

							<c:set var="menuAuthVar" value="${menuAllowedRole}" />

							<c:if test="${fn:contains(userAuthVar, menuAuthVar)}">
