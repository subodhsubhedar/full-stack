...
public interface LibraryDao {
	...
	Set<Book> findAllBooksSortByTitle() throws LibraryDaoException;

	Set<Subject> findAllSubjectsSortByTitle() throws LibraryDaoException;
	
	Set<Book> findAllBooksSortByPublishdDt() throws LibraryDaoException;
