...
public class MainMenu {
	...
	//	mainMenuMap.put(9, "List all Books Sorted by Title");
	//	mainMenuMap.put(10, "List all Subjects Sorted by Subject Title");
	//	mainMenuMap.put(11, "List all Books Sorted by Published date");
